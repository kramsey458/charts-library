...
def build_test_client(tmp_path, monkeypatch, *, auto_classify_candle: bool = False):
    monkeypatch.setenv("STORAGE_MODE", "local")
    monkeypatch.setenv("LOCAL_STORAGE_DIR", str(tmp_path / "storage"))
    monkeypatch.setenv("AUTO_CLASSIFY_CANDLE", "true" if auto_classify_candle else "false")
    app = create_app()
